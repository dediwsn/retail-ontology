...
// Sidebar company-logo button. Default = AWS, but click-cycles through
// presets and persists the choice in localStorage. Designed for live demo
// swap without a redeploy. To add a real brand logo, see
...
export const LOGO_PRESETS: LogoPreset[] = [
  ...
  { id: 'demo-emerald',  label: 'Retail Demo', src: '/logos/demo-emerald.svg' },
  { id: 'demo-violet',   label: 'CPG Demo',    src: '/logos/demo-violet.svg' },
];

const STORAGE_KEY = 'ontology-retail.company-logo';
...
export function CompanyLogo() {
  ...
  // Avoid hydration mismatch — render the default preset until client mounts.
